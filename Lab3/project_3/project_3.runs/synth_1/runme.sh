...
HD_PWD='C:/Users/oraclepc/Documents/ENES246-master/-3AndNand/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_sources.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_sources.tcl
