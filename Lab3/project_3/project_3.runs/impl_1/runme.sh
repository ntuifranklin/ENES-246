...
HD_PWD='C:/Users/oraclepc/Documents/ENES246-master/-3AndNand/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_sources.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_sources.tcl -notrace
