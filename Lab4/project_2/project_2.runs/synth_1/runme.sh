...
HD_PWD='C:/Users/oraclepc/Documents/ENES246-master/-4LotsOfGates/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sourcecode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sourcecode.tcl
