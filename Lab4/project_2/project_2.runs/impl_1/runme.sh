...
HD_PWD='C:/Users/oraclepc/Documents/ENES246-master/-4LotsOfGates/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sourcecode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sourcecode.tcl -notrace
